 ...
 */
export function parse(data, sourceBounds, clipBounds, targetWidth = 64, targetHeight = 64) {
    // 解构原始数据的边界范围
 ...
 */
function extractAndScaleFloat32Data(buffer, srcWidth, srcHeight, subBounds, targetWidth, targetHeight, fillValue = 0) {
