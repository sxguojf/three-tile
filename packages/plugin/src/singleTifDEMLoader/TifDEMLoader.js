...
import { LoaderFactory, TileGeometry } from "three-tile";
import { parse } from "./parse";
/**
 * TIF DEM terrain loader
 */
export class TifDEMLoder {
    info = {
        version: "0.10.0",
    ...
    dataType = "tif-dem";
    // 数据加载器
    _loader = new FileLoader(LoaderFactory.manager);
    /**
    ...
    async load(params) {
        ...
        if (!source.data) {
            ...
            const buffer = (await this._loader.loadAsync(url));
