 ...
 *@date: 2023-04-05
 */
import { AmbientLight, Clock, Color, DirectionalLight, EventDispatcher, FogExp2, MathUtils, PerspectiveCamera, Scene, WebGLRenderer, } from "three";
 ...
 */
export class GLViewer extends EventDispatcher {
    scene;
    renderer;
    camera;
    controls;
    ...
    _createRenderer(antialias, stencil, logarithmicDepthBuffer) {
     ...
     */
    flyTo(centerPostion, cameraPostion, animate = true, onComplete) {
