...
var Module = (() => {
	...
	return function (Module) {
		...
		if (Module["locateFile"]) {
			...
			wasmBinaryFile = new URL("lerc-wasm.wasm", import.meta.url).toString();
		}
		...
		Module["_lerc_getBlobInfo"] = function () {
			return (Module["_lerc_getBlobInfo"] = Module["asm"]["i"]).apply(null, arguments);
		};
		Module["_lerc_getDataRanges"] = function () {
			return (Module["_lerc_getDataRanges"] = Module["asm"]["j"]).apply(null, arguments);
		};
		Module["_lerc_decode"] = function () {
			return (Module["_lerc_decode"] = Module["asm"]["k"]).apply(null, arguments);
		};
		Module["_lerc_decode_4D"] = function () {
			return (Module["_lerc_decode_4D"] = Module["asm"]["l"]).apply(null, arguments);
		};
