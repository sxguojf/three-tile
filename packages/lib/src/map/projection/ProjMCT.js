 ...
 * Mercator projection
 */
export class ProjMCT extends Projection {
    constructor() {
        super(...arguments);
        this.ID = "3857"; // projeciton ID
        this.mapWidth = 2 * Math.PI * EarthRad; //E-W scacle Earth's circumference(m)
        this.mapHeight = this.mapWidth; //S-N scacle Earth's circumference(m)
