...
export declare function getAttributions(tileMap: TileMap): string[];
export declare function goHome(map: TileMap, viewer: GLViewer): void;
export declare function drawBillboards(txt: string, size?: number): HTMLCanvasElement;
