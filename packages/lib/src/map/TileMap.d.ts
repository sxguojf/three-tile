...
import { ITileGeometryLoader, ITileLoader, ITileMaterialLoader } from "../loader";
...
export declare class TileMap extends Mesh<BufferGeometry, Material, TileMapEventMap> {
    ...
    static get loaderInfo(): {
        category: string;
        dataType: string;
        info: import("../loader").ITileLoaderInfo;
    }[];
    static registerImgLoader(loader: ITileMaterialLoader): ITileMaterialLoader<Material>;
    static registerDEMloader(loader: ITileGeometryLoader): ITileGeometryLoader<BufferGeometry<import("three").NormalBufferAttributes>>;
}
export {};
