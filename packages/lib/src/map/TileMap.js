 ...
 * 瓦片地图模型
 */
export class TileMap extends Object3D {
    ...
    constructor(params) {
        ...
        this._minLevel = 2;
        this._maxLevel = 20;
        this._LODThreshold = 1;
        this.up.set(0, 0, 1);
        const { 
        // loader = new LayerLoader(this),
        loader = new TileMapLoader(), rootTile = new Tile(), minLevel = 2, imgSource, demSource, bounds, lon0 = 0, debug = 0, } = params;
     ...
     */
    getTileCount() {
        let total = 0, visible = 0, inFrustum = 0, maxLevel = 0, leaf = 0, downloading = 0;
