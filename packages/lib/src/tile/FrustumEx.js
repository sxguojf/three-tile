...
import { Frustum, Matrix3, Vector3, WebGLCoordinateSystem } from "three";
...
function findIntersectionPoint(plane1, plane2, plane3, target) {
    ...
    const A = _mat3.set(plane1.normal.x, plane1.normal.y, plane1.normal.z, plane2.normal.x, plane2.normal.y, plane2.normal.z, plane3.normal.x, plane3.normal.y, plane3.normal.z);
