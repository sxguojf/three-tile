import { Vector3 as p, InstancedBufferGeometry as $I, Matrix4 as Ag, Box3 as Ig, Frustum as gg, Mesh as CI, MeshStandardMaterial as Qg, FrontSide as Cg, PlaneGeometry as XA, BufferAttribute as TA, LoadingManager as Eg, Vector2 as j, Box2 as Bg, MeshBasicMaterial as aI, ImageLoader as EI, Texture as kI, SRGBColorSpace as UI, CanvasTexture as dI, Raycaster as JI, SpriteMaterial as ig, Sprite as Dg, Clock as KI, FileLoader as og, MathUtils as BI, EventDispatcher as qI, MOUSE as oA, TOUCH as hA, Spherical as hI, Quaternion as RI, Ray as sg, Plane as tg, Scene as ag, Color as jA, FogExp2 as II, WebGLRenderer as hg, PerspectiveCamera as Rg, AmbientLight as Ng, DirectionalLight as eg, ShaderMaterial as wg, UniformsUtils as yg, UniformsLib as Fg } from "three";
const rg = "0.10.0", NI = {
  name: "GuoJF",
  email: "hz_gjf@163.com"
};
var dA = /* @__PURE__ */ ((Q) => (Q[Q.none = 0] = "none", Q[Q.create = 1] = "create", Q[Q.remove = 2] = "remove", Q))(dA || {});
const eI = 1.02;
function cg(Q, A) {
...
function Mg(Q, A, g, I) {
  ...
  if (I === 0 && R) {
    const h = g, t = new p(0.5, 1, 1), r = new X(i, h, E), F = new X(i, h, E);
    r.position.set(-0.25, 0, D), r.scale.copy(t), F.position.set(o, 0, D), F.scale.copy(t), C.push(r, F);
  } else {
    const h = g * 2, t = new p(0.5, 0.5, 1), r = new X(i, h, E), F = new X(i + 1, h, E), c = new X(i, h + 1, E), e = new X(i + 1, h + 1, E);
    r.position.set(-0.25, o, D), r.scale.copy(t), F.position.set(o, o, D), F.scale.copy(t), c.position.set(-0.25, -0.25, D), c.scale.copy(t), e.position.set(o, -0.25, D), e.scale.copy(t), C.push(r, F, c, e);
  }
  return C;
}
const Lg = 10, kg = new $I(), Ug = new p(), dg = new Ag(), Jg = new Ig(new p(-0.5, -0.5, 0), new p(0.5, 0.5, 9)), wI = new gg();
class X extends CI {
  ...
  constructor(A = 0, g = 0, I = 0) {
    super(kg, []), this.x = A, this.y = g, this.z = I, this.name = `Tile ${I}-${A}-${g}`, this.up.set(0, 0, 1), this.matrixAutoUpdate = !1;
  }
  /**
   ...
   */
  LOD(A) {
    if (X.downloadThreads > Lg)
      return { action: dA.none };
    let g = [];
    const { loader: I, minLevel: C, maxLevel: E, LODThreshold: i } = A, D = Sg(this, C, E, i);
    return D === dA.create && (g = Mg(I, this.x, this.y, this.z), this.add(...g)), { action: D, newTiles: g };
  }
  /**
  ...
  async _load(A) {
    X._downloadThreads++;
    const { x: g, y: I, z: C } = this, E = await A.load({ x: g, y: I, z: C, bounds: [-1 / 0, -1 / 0, 1 / 0, 1 / 0] });
    return this.material = E.materials, this.geometry = E.geometry, this.maxZ = this.geometry.boundingBox?.max.z || 0, this._loaded = !0, X._downloadThreads--, this;
  }
  /** New tile init */
  _init() {
    this.updateMatrix(), this.updateMatrixWorld(), this.sizeInWorld = ng(this);
  }
  /**
   * Updates the tile.
  ...
  update(A) {
    if (console.assert(this.z === 0), !this.parent)
      return this;
    wI.setFromProjectionMatrix(
      dg.multiplyMatrices(A.camera.projectionMatrix, A.camera.matrixWorldInverse)
    );
    const g = A.camera.getWorldPosition(Ug);
    return this.traverse((I) => {
      I.receiveShadow = this.receiveShadow, I.castShadow = this.castShadow;
      const C = Jg.clone().applyMatrix4(I.matrixWorld);
      I.inFrustum = wI.intersectsBox(C), I.distToCamera = cg(I, g);
  ...
  _doAction(A, g, I, C) {
    const E = this;
    return g === dA.create ? I?.forEach((i) => {
    ...
    }) : g === dA.remove && (A.showing = !0, A._unLoad(!1, C.loader), E.dispatchEvent({ type: "tile-unload", tile: A })), this;
  }
  /**
...
var JA = /* @__PURE__ */ ((Q) => (Q[Q.Unknown = 0] = "Unknown", Q[Q.Point = 1] = "Point", Q[Q.Linestring = 2] = "Linestring", Q[Q.Polygon = 3] = "Polygon", Q))(JA || {});
class lQ {
  /**
   * 渲染矢量数据
   * @param ctx 渲染上下文
  ...
  render(A, g, I, C, E = 1) {
    ...
    (C.fill || g === JA.Point) && (A.globalAlpha = C.fillOpacity || 0.5, A.fillStyle = C.fillColor || C.color || "#3388ff", A.fill(C.fillRule || "evenodd")), (C.stroke ?? !0) && (C.weight ?? 1) > 0 && (A.globalAlpha = C.opacity || 1, A.lineWidth = C.weight || 1, A.strokeStyle = C.color || "#3388ff", A.setLineDash(C.dashArray || []), A.stroke());
  }
  // 渲染点要素
...
function HI(Q, A, g, I) {
  const C = I ? qg(I, Q.position.value) : Kg(A), E = C.length, i = new Float32Array(E * 6), D = new Float32Array(E * 4), o = new A.constructor(E * 6), R = new Float32Array(E * 6);
  for (let t = 0; t < E; t++)
    Yg({
      edge: C[t],
      edgeIndex: t,
  ...
  Q.position.value = PA(Q.position.value, i), Q.texcoord.value = PA(Q.texcoord.value, D), Q.normal.value = PA(Q.normal.value, R);
  const h = PA(A, o);
  return {
    attributes: Q,
    indices: h
...
function Hg(Q, A = !0) {
  ...
  const g = Math.floor(Math.sqrt(Q.length)), I = g, C = g, E = lI(C, I), i = lg(Q, C, I);
  return A ? HI(i, E, 1) : { attributes: i, indices: E };
}
function lg(Q, A, g) {
  ...
  return {
    ...
    // 法线属性
    normal: { value: fI(C, lI(A, g)), size: 3 }
  };
}
function lI(Q, A) {
...
function fI(Q, A) {
  ...
  for (let I = 0; I < A.length; I += 3) {
    const C = A[I] * 3, E = A[I + 1] * 3, i = A[I + 2] * 3, D = Q[C], o = Q[C + 1], R = Q[C + 2], h = Q[E], t = Q[E + 1], r = Q[E + 2], F = Q[i], c = Q[i + 1], e = Q[i + 2], L = h - D, n = t - o, y = r - R, M = F - D, k = c - o, d = e - R, q = n * d - y * k, G = y * M - L * d, J = L * k - n * M, Y = Math.sqrt(q * q + G * G + J * J), l = [0, 0, 1];
    if (Y > 0) {
      const K = 1 / Y;
...
class iI extends XA {
   ...
   */
  setData(A) {
    A instanceof Float32Array && (A = Hg(A, !0)), A = HI(A.attributes, A.indices, 10), this.setIndex(new TA(A.indices, 1));
    const { attributes: g } = A;
    return this.setAttribute("position", new TA(g.position.value, g.position.size)), this.setAttribute("uv", new TA(g.texcoord.value, g.texcoord.size)), this.setAttribute("normal", new TA(g.normal.value, g.normal.size)), this.computeBoundingBox(), this.computeBoundingSphere(), this;
  }
  // /**
...
class ug {
  ...
  update() {
    ...
    for (let D = A - 1; D >= 0; D--) {
      const o = D * 4, R = I[o + 0], h = I[o + 1], t = I[o + 2], r = I[o + 3], F = R + t >> 1, c = h + r >> 1, e = F + c - h, L = c + R - F, n = (E[h * C + R] + E[r * C + t]) / 2, y = c * C + F, M = Math.abs(n - E[y]);
      if (i[y] = Math.max(i[y], M), D < g) {
        const k = (h + L >> 1) * C + (R + e >> 1), d = (r + L >> 1) * C + (t + e >> 1);
  ...
  getGeometryData(A = 0) {
    ...
    let r = E * 2, F = i * 3;
    const c = new Uint16Array(r), e = new Uint32Array(F);
    let L = 0;
    function n(y, M, k, d, q, G) {
      ...
      if (Math.abs(y - q) + Math.abs(M - G) > 1 && C[Y * g + J] > A)
        ...
        c[2 * l] = y, c[2 * l + 1] = M, c[2 * K] = k, c[2 * K + 1] = d, c[2 * f] = q, c[2 * f + 1] = G, e[L++] = l, e[L++] = K, e[L++] = f;
      }
    }
    return n(0, 0, D, D, D, 0), n(D, D, 0, 0, 0, D), {
      attributes: this._getMeshAttributes(this.terrain, c, e),
      indices: e
    };
  }
...
const b = {
  ...
  registerMaterialLoader(Q) {
    b.imgLoaderMap.set(Q.dataType, Q), Q.info.author = Q.info.author ?? NI.name, console.log(`* Register imageLoader: '${Q.dataType}', Author: '${Q.info.author}'`);
  },
  /**
  ...
  registerGeometryLoader(Q) {
    b.demLoaderMap.set(Q.dataType, Q), Q.info.author = Q.info.author ?? NI.name, console.log(`* Register terrainLoader: '${Q.dataType}', Author: '${Q.info.author}'`);
  },
  /**
   ...
   */
  getMaterialLoader(Q) {
    const A = b.imgLoaderMap.get(Q.dataType);
    if (A)
      return A;
   ...
   */
  getGeometryLoader(Q) {
    const A = b.demLoaderMap.get(Q.dataType);
    if (A)
      return A;
    throw `Source dataType "${Q.dataType}" is not support!`;
  },
  getLoadersInfo() {
    const Q = Array.from(this.imgLoaderMap.values()).map((g) => ({
      category: "image",
      dataType: g.dataType,
      info: g.info
    })), A = Array.from(this.demLoaderMap.values()).map((g) => ({
      category: "terrain",
      dataType: g.dataType,
      info: g.info
    }));
...
function oI(Q, A, g, I) {
  ...
  const C = Og(A, g, I, Q.maxLevel), E = C.parentNO;
  return { url: Q._getUrl(E.x, E.y, E.z), clipBounds: C.bounds };
}
function Og(Q, A, g, I) {
  const C = g - I, E = { x: Q >> C, y: A >> C, z: g - C }, i = Math.pow(2, C), D = Math.pow(0.5, C), o = Q % i / i - 0.5 + D / 2, R = A % i / i - 0.5 + D / 2, h = new j(o, R), t = new Bg().setFromCenterAndSize(h, new j(D, D)), r = [
    t.min.x + 0.5,
    t.min.y + 0.5,
    t.max.x + 0.5,
    t.max.y + 0.5
...
class uI {
  ...
  async loadGeometry(A) {
    ...
    if (this.demSource && A.z >= this.demSource.minLevel && this._isBoundsInSourceBounds(this.demSource, A.bounds)) {
      const I = b.getGeometryLoader(this.demSource);
      I.useWorker = this.useWorker;
      const C = this.demSource;
      g = await I.load({ source: C, ...A }).catch((E) => (console.error("Load material error", C.dataType, A), new XA())), g.addEventListener("dispose", () => {
        I.unload && I.unload(g);
      });
    } else
      g = new XA();
  ...
  async loadMaterial(A) {
    const I = this.imgSource.filter(
      ...
      const E = b.getMaterialLoader(C);
      E.useWorker = this.useWorker;
      const i = await E.load({ source: C, ...A }).catch((o) => (console.error("Load material error", C.dataType, A), new aI())), D = (o) => {
        E.unload && E.unload(o.target), o.target.removeEventListener("dispose", D);
      };
      return i instanceof aI || i.addEventListener("dispose", D), i;
    });
...
class uQ {
   ...
   */
  async load(A, g, I, C) {
    const E = new kI(new Image(1, 1));
    E.colorSpace = UI;
    const { url: i, clipBounds: D } = oI(A, g, I, C);
    if (i) {
      const o = await this.loader.loadAsync(i);
      C > A.maxLevel ? E.image = pg(o, D) : E.image = o;
    }
    return E;
  }
}
function pg(Q, A) {
  const g = Q.width, I = new OffscreenCanvas(g, g), C = I.getContext("2d"), { sx: E, sy: i, sw: D, sh: o } = DI(A, Q.width);
...
class xI {
   ...
   */
  async load(A) {
    const { source: g, x: I, y: C, z: E } = A, { url: i, clipBounds: D } = oI(g, I, C, E);
    if (!i)
      return new iI();
    const o = await this.doLoad(i, { source: g, x: I, y: C, z: E, bounds: D });
    return b.manager.parseEnd(i), o;
  }
}
class Wg {
  info = {
   ...
   */
  async load(A) {
    const { source: g, x: I, y: C, z: E } = A, i = new YI(), { url: D, clipBounds: o } = oI(g, I, C, E);
    if (D) {
      const R = await this.doLoad(D, { source: g, x: I, y: C, z: E, bounds: o });
      i.map = R, b.manager.parseEnd(D);
    }
    return i;
  }
}
class xQ {
  ...
  async load(A) {
    ...
    this.drawTile(g, A);
    const I = new dI(g.canvas.transferToImageBitmap());
    return new YI({
      transparent: !0,
      map: I,
...
class mg extends Wg {
   ...
   */
  async doLoad(A, g) {
    const I = await this.loader.loadAsync(A), C = new kI();
    C.colorSpace = UI;
    const { bounds: E } = g;
    return E[2] - E[0] < 1 ? C.image = Tg(I, E) : C.image = I, C.needsUpdate = !0, C;
  }
}
function Tg(Q, A) {
  const g = Q.width, I = new OffscreenCanvas(g, g), C = I.getContext("2d"), { sx: E, sy: i, sw: D, sh: o } = DI(A, Q.width);
...
function FI(Q, A) {
  const g = new p(0, -1, 0), I = new p(A.x, 10, A.z), C = new JI(I, g);
  return WI(Q, C);
}
function bg(Q, A, g) {
  const I = new JI();
  return I.setFromCamera(g, Q), WI(A, I);
}
function Zg(Q) {
...
function OQ(Q, A = 128) {
  const g = new dI(Xg(Q, A)), I = new ig({
    map: g,
    sizeAttenuation: !1
  }), C = new Dg(I);
...
class qA extends CI {
   ...
   */
  set lon0(A) {
    this.projection.lon0 !== A && (A != 0 && this.minLevel < 1 && console.warn(`Map centralMeridian is ${this.lon0}, minLevel must > 0`), this.projection = yI.createFromID(this.projection.ID, A), this.reload());
  }
  _projection = new pI(0);
  /**
  ...
  set imgSource(A) {
    ...
    this.projection = yI.createFromID(g[0].projectionID, this.projection.lon0), this._imgSource = g, this.loader.imgSource = g, this.dispatchEvent({ type: "source-changed", source: A });
  }
  _demSource;
  /**
  ...
  constructor(A) {
    ...
    this.loader = g, I.matrixAutoUpdate = !0, I.scale.set(this.projection.mapWidth, this.projection.mapHeight, this.projection.mapDepth), this.rootTile = I, this.minLevel = C, this.maxLevel = E, this.imgSource = i, this.demSource = D, this.lon0 = o, this.add(I), I.updateMatrix(), Zg(this);
  }
  /**
   ...
   */
  get downloading() {
    return X.downloadThreads;
  }
  static get loaderInfo() {
    return b.getLoadersInfo();
  }
  static registerImgLoader(A) {
    return b.registerMaterialLoader(A), A;
  }
  static registerDEMloader(A) {
    return b.registerGeometryLoader(A), A;
  }
}
qA.registerImgLoader(new mg());
class mI {
  constructor(A = 4) {
...
var vg = (() => {
  ...
  return function(g) {
    ...
    o ? (D ? R = require("path").dirname(R) + "/" : R = __dirname + "/", L = () => {
      e || (c = require("fs"), e = require("path"));
    }, t = function(a, U) {
      return L(), a = e.normalize(a), c.readFileSync(a, U ? void 0 : "utf8");
    }, F = (s) => {
      var a = t(s, !0);
      return a.buffer || (a = new Uint8Array(a)), a;
    }, r = (s, a, U) => {
      L(), s = e.normalize(s), c.readFile(s, function(x, B) {
        x ? U(x) : a(B.buffer);
      });
    ...
    }) : (i || D) && (D ? R = self.location.href : typeof document < "u" && document.currentScript && (R = document.currentScript.src), Q && (R = Q), R.indexOf("blob:") !== 0 ? R = R.substr(0, R.replace(/[?#].*/, "").lastIndexOf("/") + 1) : R = "", t = (s) => {
    ...
    function q(s, a, U) {
      ...
      for (var N = ""; a < B; ) {
        ...
        var S = s[a++] & 63;
        if ((w & 224) == 192) {
          N += String.fromCharCode((w & 31) << 6 | S);
          continue;
        }
        var O = s[a++] & 63;
        if ((w & 240) == 224 ? w = (w & 15) << 12 | S << 6 | O : w = (w & 7) << 18 | S << 12 | O << 6 | s[a++] & 63, w < 65536)
          ...
          var Z = w - 65536;
          N += String.fromCharCode(55296 | Z >> 10, 56320 | Z & 1023);
        }
      }
      return N;
    }
    ...
    function lA() {
      ...
      function B() {
        return !y && typeof WebAssembly.instantiateStreaming == "function" && !RA(T) && !NA(T) && !o && typeof fetch == "function" ? fetch(T, { credentials: "same-origin" }).then(function(w) {
    ...
    function FA(s) {
      for (; s.length > 0; ) {
        ...
        var U = a.func;
        typeof U == "number" ? a.arg === void 0 ? fA(U)() : fA(U)(a.arg) : U(a.arg === void 0 ? null : a.arg);
      }
    }
    var rA = [];
    function fA(s) {
    ...
    function pA(s) {
      ...
      for (var B = 1; B <= 4; B *= 2) {
        ...
        var w = Math.min(U, x(Math.max(s, N), 65536)), S = OA(w);
        if (S)
          return !0;
      }
      return !1;
    ...
    lA(), g.___wasm_call_ctors = function() {
    ...
    var WA = g.___cxa_is_pointer_type = function() {
      return (WA = g.___cxa_is_pointer_type = g.asm.p).apply(
        null,
        arguments
      );
    }, wA;
...
function zg(Q = {}) {
  ...
  return bA = vg({ locateFile: A }).then(
    (g) => g.ready.then(() => {
      $g(g), PI = !0;
    })
  ), bA;
...
function $g(Q) {
  ...
  let D;
  const o = Object.values(i).find((h) => h && "buffer" in h && h.buffer === Q.HEAPU8.buffer), R = (h) => {
    const t = h.map((e) => _g(e)), r = t.reduce((e, L) => e + L), F = A(r);
  ...
  VA.getBlobInfo = (h) => {
    const F = new Uint8Array(48), c = new Uint8Array(3 * 8), [e, L, n] = R([h.length, F.length, c.length]);
    D.set(h, e), D.set(F, L), D.set(c, n);
    let y = I(e, h.length, L, n, 12, 3);
    if (y)
      throw g(e), `lerc-getBlobInfo: error code is ${y}`;
    ...
    const M = new Uint32Array(F.buffer), k = new Float64Array(c.buffer), [
      ...
      maxZerror: k[2],
      statistics: [],
      bandCountWithNoData: m
    };
    if (m)
      return g(e), W;
    if (u === 1 && l === 1)
      return g(e), W.statistics.push({
        minValue: k[0],
        maxValue: k[1]
      }), W;
    const P = u * l * 8, V = new Uint8Array(P), CA = new Uint8Array(P);
    let AA = e, v = 0, EA = 0, sA = !1;
    if (D.byteLength < e + P * 2 ? (g(e), sA = !0, [AA, v, EA] = R([h.length, P, P]), D.set(h, AA)) : [v, EA] = R([P, P]), D.set(V, v), D.set(CA, EA), y = C(AA, h.length, u, l, v, EA), y)
      throw g(AA), sA || g(v), `lerc-getDataRanges: error code is ${y}`;
    D = new Uint8Array(o.buffer), aA(D, v, V), aA(D, EA, CA);
    const z = new Float64Array(V.buffer), gA = new Float64Array(CA.buffer), yA = W.statistics;
    for (let _ = 0; _ < l; _++)
      if (u > 1) {
        const IA = z.slice(_ * u, (_ + 1) * u), tA = gA.slice(_ * u, (_ + 1) * u), RA = Math.min.apply(null, IA), NA = Math.max.apply(null, tA);
        yA.push({
          minValue: RA,
          maxValue: NA,
    ...
    return g(AA), sA || g(v), W;
  }, VA.decode = (h, t) => {
    const { maskCount: r, depthCount: F, bandCount: c, width: e, height: L, dataType: n, bandCountWithNoData: y } = t, M = TI[n], k = e * L, d = new Uint8Array(k * c), q = k * F * c * M.size, G = new Uint8Array(q), J = new Uint8Array(c), Y = new Uint8Array(c * 8), [l, K, f, H, u] = R([
      h.length,
      d.length,
      G.length,
      J.length,
    ...
    if (m)
      throw g(l), `lerc-decode: error code is ${m}`;
...
function IQ(Q, A = {}) {
  var g, I;
  const C = (g = A.inputOffset) !== null && g !== void 0 ? g : 0, E = Q instanceof Uint8Array ? Q.subarray(C) : new Uint8Array(Q, C), i = VA.getBlobInfo(E), { data: D, maskData: o } = VA.decode(E, i), { width: R, height: h, bandCount: t, dimCount: r, depthCount: F, dataType: c, maskCount: e, statistics: L } = i, n = TI[c], y = new n.ctor(D.buffer), M = [], k = [], d = R * h, q = d * F, G = (I = A.returnInterleaved) !== null && I !== void 0 ? I : A.returnPixelInterleavedDims;
  for (let H = 0; H < t; H++) {
    const u = y.subarray(H * q, (H + 1) * q);
    if (G)
      M.push(u);
    else {
      const m = AQ(u, d, F, n.ctor);
      M.push(m);
    }
    k.push(o.subarray(H * q, (H + 1) * q));
  }
  const J = e === 0 ? null : e === 1 ? k[0] : new Uint8Array(d);
  if (e > 1) {
    J.set(k[0]);
  ...
  const K = e === t && t > 1 ? k : null, { pixelType: f } = n;
  return {
    width: R,
    height: h,
    pixelType: f,
...
function QQ(Q, A, g) {
  let I = Q;
  g[2] - g[0] < 1 && (I = CQ(Q, g));
  const { array: C, width: E } = I, D = new fg(E).createTile(C), o = gQ[A] / 1e3 || 0;
  return D.getGeometryData(o);
}
function CQ(Q, A) {
  function g(D, o, R, h, t, r, F, c) {
    const e = new Float32Array(t * r);
    for (let n = 0; n < r; n++)
      for (let y = 0; y < t; y++) {
  ...
  const I = EQ(A, Q.width), C = I.sw + 1, E = I.sh + 1;
  return { array: g(
    Q.array,
    Q.width,
    I.sx,
...
const bI = "", BQ = (Q) => Uint8Array.from(atob(Q), (A) => A.charCodeAt(0)), cI = typeof self < "u" && self.Blob && new Blob([BQ(bI)], { type: "text/javascript;charset=utf-8" });
function iQ(Q) {
  let A;
  try {
    if (A = cI && (self.URL || self.webkitURL).createObjectURL(cI), !A) throw "";
...
class oQ extends xI {
  ...
  dataType = "lerc";
  // 图像加载器
  fileLoader = new og(b.manager);
  _workerPool = new mI(0);
  constructor() {
    super(), this.fileLoader.setResponseType("arraybuffer"), this._workerPool.setWorkerCreator(() => new iQ()), zg({ locateFile: () => Vg });
  }
  /**
   * 解码给定缓冲区中的Lerc数据
   *
   ...
   */
  async decode(A) {
    await sQ(rI()), console.assert(rI());
    const { height: g, width: I, pixels: C } = IQ(A), E = new Float32Array(g * I);
    for (let i = 0; i < E.length; i++)
      E[i] = C[0][i] / 1e3;
  ...
  async doLoad(A, g) {
    ...
    let D;
    return this.useWorker ? (this._workerPool.pool === 0 && this._workerPool.setWorkerLimit(DQ), D = (await this._workerPool.postMessage({ demData: C, z: E, clipBounds: i }, [
      C.array.buffer
    ])).data) : D = QQ(C, E, i), new iI().setData(D);
  }
}
function sQ(Q, A = 100) {
...
const ZI = "", hQ = (Q) => Uint8Array.from(atob(Q), (A) => A.charCodeAt(0)), nI = typeof self < "u" && self.Blob && new Blob([hQ(ZI)], { type: "text/javascript;charset=utf-8" });
function RQ(Q) {
  let A;
  try {
...
class eQ extends xI {
  ...
  // 使用imageLoader下载
  imageLoader = new EI(b.manager);
  _workerPool = new mI(0);
  constructor() {
    super(), this._workerPool.setWorkerCreator(() => new RQ());
  }
  // 下载数据
  /**
   ...
   */
  async doLoad(A, g) {
    const I = await this.imageLoader.loadAsync(A), C = BI.clamp((g.z + 2) * 3, 2, 64), E = wQ(I, g.bounds, C);
    let i;
    this.useWorker ? (this._workerPool.pool === 0 && this._workerPool.setWorkerLimit(NQ), i = (await this._workerPool.postMessage({ imgData: E }, [E.data.buffer])).data) : i = tQ(E);
    const D = new iI();
    return D.setData(i), D;
  }
}
function wQ(Q, A, g) {
  const I = DI(A, Q.width);
  g = Math.min(g, I.sw);
...
const GI = { type: "change" }, AI = { type: "start" }, SI = { type: "end" }, ZA = new sg(), MI = new tg(), FQ = Math.cos(70 * BI.DEG2RAD);
class rQ extends qI {
  constructor(A, g) {
    super(), this.object = A, this.domElement = g, this.domElement.style.touchAction = "none", this.enabled = !0, this.target = new p(), this.cursor = new p(), this.minDistance = 0, this.maxDistance = 1 / 0, this.minZoom = 0, this.maxZoom = 1 / 0, this.minTargetRadius = 0, this.maxTargetRadius = 1 / 0, this.minPolarAngle = 0, this.maxPolarAngle = Math.PI, this.minAzimuthAngle = -1 / 0, this.maxAzimuthAngle = 1 / 0, this.enableDamping = !1, this.dampingFactor = 0.05, this.enableZoom = !0, this.zoomSpeed = 1, this.enableRotate = !0, this.rotateSpeed = 1, this.enablePan = !0, this.panSpeed = 1, this.screenSpacePanning = !0, this.keyPanSpeed = 7, this.zoomToCursor = !1, this.autoRotate = !1, this.autoRotateSpeed = 2, this.keys = { LEFT: "ArrowLeft", UP: "ArrowUp", RIGHT: "ArrowRight", BOTTOM: "ArrowDown" }, this.mouseButtons = { LEFT: oA.ROTATE, MIDDLE: oA.DOLLY, RIGHT: oA.PAN }, this.touches = { ONE: hA.ROTATE, TWO: hA.DOLLY_PAN }, this.target0 = this.target.clone(), this.position0 = this.object.position.clone(), this.zoom0 = this.object.zoom, this._domElementKeyEvents = null, this.getPolarAngle = function() {
      ...
      I.target.copy(I.target0), I.object.position.copy(I.position0), I.object.zoom = I.zoom0, I.object.updateProjectionMatrix(), I.dispatchEvent(GI), I.update(), E = C.NONE;
    }, this.update = function() {
      const B = new p(), N = new RI().setFromUnitVectors(A.up, new p(0, 1, 0)), w = N.clone().invert(), S = new p(), O = new RI(), Z = new p(), $ = 2 * Math.PI;
      return function(_I = null) {
        const sI = I.object.position;
        B.copy(sI).sub(I.target), B.applyQuaternion(N), D.setFromVector3(B), I.autoRotate && E === C.NONE && f(l(_I)), I.enableDamping ? (D.theta += o.theta * I.dampingFactor, D.phi += o.phi * I.dampingFactor) : (D.theta += o.theta, D.phi += o.phi);
        ...
        if (B.setFromSpherical(D), B.applyQuaternion(w), sI.copy(I.target).add(B), I.object.lookAt(I.target), I.enableDamping === !0 ? (o.theta *= 1 - I.dampingFactor, o.phi *= 1 - I.dampingFactor, h.multiplyScalar(1 - I.dampingFactor)) : (o.set(0, 0, 0), h.set(0, 0, 0)), I.zoomToCursor && q) {
          let DA = null;
          if (I.object.isPerspectiveCamera) {
            ...
            const tI = new p(d.x, d.y, 0);
            tI.unproject(I.object), I.object.position.sub(tI).add(kA), I.object.updateMatrixWorld(), DA = B.length();
          } else
            console.warn("WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled."), I.zoomToCursor = !1;
          DA !== null && (this.screenSpacePanning ? I.target.set(0, 0, -1).transformDirection(I.object.matrix).multiplyScalar(DA).add(I.object.position) : (ZA.origin.copy(I.object.position), ZA.direction.set(0, 0, -1).transformDirection(I.object.matrix), Math.abs(I.object.up.dot(ZA.direction)) < FQ ? A.lookAt(I.target) : (MI.setFromNormalAndCoplanarPoint(I.object.up, I.target), ZA.intersectPlane(MI, I.target))));
        } else if (I.object.isOrthographicCamera) {
        ...
        return R = 1, q = !1, LA || S.distanceToSquared(I.object.position) > i || 8 * (1 - O.dot(I.object.quaternion)) > i || Z.distanceToSquared(I.target) > i ? (I.dispatchEvent(GI), S.copy(I.object.position), O.copy(I.object.quaternion), Z.copy(I.target), !0) : !1;
      };
    }(), this.dispose = function() {
      I.domElement.removeEventListener("contextmenu", wA), I.domElement.removeEventListener("pointerdown", uA), I.domElement.removeEventListener("pointercancel", eA), I.domElement.removeEventListener("wheel", xA), I.domElement.removeEventListener("pointermove", nA), I.domElement.removeEventListener("pointerup", eA), I.domElement.getRootNode().removeEventListener("keydown", OA, { capture: !0 }), I._domElementKeyEvents !== null && (I._domElementKeyEvents.removeEventListener("keydown", GA), I._domElementKeyEvents = null);
    };
    const I = this, C = {
      NONE: -1,
      ROTATE: 0,
    ...
    let E = C.NONE;
    const i = 1e-6, D = new hI(), o = new hI();
    let R = 1;
    const h = new p(), t = new j(), r = new j(), F = new j(), c = new j(), e = new j(), L = new j(), n = new j(), y = new j(), M = new j(), k = new p(), d = new j();
    let q = !1;
    const G = [], J = {};
    let Y = !1;
    function l(B) {
    ...
    function K(B) {
      const N = Math.abs(B * 0.01);
      return Math.pow(0.95, I.zoomSpeed * N);
    }
    function f(B) {
      o.theta -= B;
    }
    ...
    const u = function() {
      ...
      return function(w, S) {
        ...
        if (I.object.isPerspectiveCamera) {
          const Z = I.object.position;
          B.copy(Z).sub(I.target);
          let $ = B.length();
          $ *= Math.tan(I.object.fov / 2 * Math.PI / 180), u(2 * w * $ / O.clientHeight, I.object.matrix), m(2 * S * $ / O.clientHeight, I.object.matrix);
        } else I.object.isOrthographicCamera ? (u(w * (I.object.right - I.object.left) / I.object.zoom / O.clientWidth, I.object.matrix), m(S * (I.object.top - I.object.bottom) / I.object.zoom / O.clientHeight, I.object.matrix)) : (console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled."), I.enablePan = !1);
      };
    }();
    function P(B) {
    ...
    function CA(B, N) {
      if (!I.zoomToCursor)
        return;
      q = !0;
      const w = I.domElement.getBoundingClientRect(), S = B - w.left, O = N - w.top, Z = w.width, $ = w.height;
      d.x = S / Z * 2 - 1, d.y = -(O / $) * 2 + 1, k.set(d.x, d.y, 1).unproject(I.object).sub(I.object.position).normalize();
    }
    function AA(B) {
    ...
    function z(B) {
      ...
      f(2 * Math.PI * F.x / N.clientHeight), H(2 * Math.PI * F.y / N.clientHeight), t.copy(r), I.update();
    }
    function gA(B) {
      y.set(B.clientX, B.clientY), M.subVectors(y, n), M.y > 0 ? P(K(M.y)) : M.y < 0 && V(K(M.y)), n.copy(y), I.update();
    }
    function yA(B) {
      e.set(B.clientX, B.clientY), L.subVectors(e, c).multiplyScalar(I.panSpeed), W(L.x, L.y), c.copy(e), I.update();
    }
    function _(B) {
    ...
    function IA(B) {
      ...
      switch (B.code) {
        case I.keys.UP:
          B.ctrlKey || B.metaKey || B.shiftKey ? H(2 * Math.PI * I.rotateSpeed / I.domElement.clientHeight) : W(0, I.keyPanSpeed), N = !0;
          break;
        case I.keys.BOTTOM:
          B.ctrlKey || B.metaKey || B.shiftKey ? H(-2 * Math.PI * I.rotateSpeed / I.domElement.clientHeight) : W(0, -I.keyPanSpeed), N = !0;
          break;
        case I.keys.LEFT:
          B.ctrlKey || B.metaKey || B.shiftKey ? f(2 * Math.PI * I.rotateSpeed / I.domElement.clientHeight) : W(I.keyPanSpeed, 0), N = !0;
          break;
        case I.keys.RIGHT:
          B.ctrlKey || B.metaKey || B.shiftKey ? f(-2 * Math.PI * I.rotateSpeed / I.domElement.clientHeight) : W(-I.keyPanSpeed, 0), N = !0;
          break;
      }
      N && (B.preventDefault(), I.update());
    }
    function tA(B) {
      if (G.length === 1)
        t.set(B.pageX, B.pageY);
      else {
        const N = U(B), w = 0.5 * (B.pageX + N.x), S = 0.5 * (B.pageY + N.y);
        t.set(w, S);
      }
    }
    function RA(B) {
    ...
    function NA(B) {
      const N = U(B), w = B.pageX - N.x, S = B.pageY - N.y, O = Math.sqrt(w * w + S * S);
      n.set(0, O);
    }
    function T(B) {
      I.enableZoom && NA(B), I.enablePan && RA(B);
    }
    function YA(B) {
      I.enableZoom && NA(B), I.enableRotate && tA(B);
    }
    function HA(B) {
      if (G.length == 1)
      ...
      const N = I.domElement;
      f(2 * Math.PI * F.x / N.clientHeight), H(2 * Math.PI * F.y / N.clientHeight), t.copy(r);
    }
    function lA(B) {
      if (G.length === 1)
      ...
      L.subVectors(e, c).multiplyScalar(I.panSpeed), W(L.x, L.y), c.copy(e);
    }
    function FA(B) {
      const N = U(B), w = B.pageX - N.x, S = B.pageY - N.y, O = Math.sqrt(w * w + S * S);
      y.set(0, O), M.set(0, Math.pow(y.y / n.y, I.zoomSpeed)), P(M.y), n.copy(y);
      const Z = (B.pageX + N.x) * 0.5, $ = (B.pageY + N.y) * 0.5;
      CA(Z, $);
    }
    function rA(B) {
      I.enableZoom && FA(B), I.enablePan && lA(B);
    }
    function fA(B) {
      I.enableZoom && FA(B), I.enableRotate && HA(B);
    }
    function uA(B) {
      I.enabled !== !1 && (G.length === 0 && (I.domElement.setPointerCapture(B.pointerId), I.domElement.addEventListener("pointermove", nA), I.domElement.addEventListener("pointerup", eA)), !s(B) && ($A(B), B.pointerType === "touch" ? SA(B) : vA(B)));
    }
    function nA(B) {
      I.enabled !== !1 && (B.pointerType === "touch" ? WA(B) : zA(B));
    }
    function eA(B) {
      switch (MA(B), G.length) {
        case 0:
          I.domElement.releasePointerCapture(B.pointerId), I.domElement.removeEventListener("pointermove", nA), I.domElement.removeEventListener("pointerup", eA), I.dispatchEvent(SI), E = C.NONE;
          break;
        case 1:
          const N = G[0], w = J[N];
          SA({ pointerId: N, pageX: w.x, pageY: w.y });
          break;
      }
    }
    function vA(B) {
    ...
    function xA(B) {
      I.enabled === !1 || I.enableZoom === !1 || E !== C.NONE || (B.preventDefault(), I.dispatchEvent(AI), _(_A(B)), I.dispatchEvent(SI));
    }
    function _A(B) {
      const N = B.deltaMode, w = {
        clientX: B.clientX,
        clientY: B.clientY,
        deltaY: B.deltaY
      };
    ...
    function OA(B) {
      B.key === "Control" && (Y = !0, I.domElement.getRootNode().addEventListener("keyup", pA, { passive: !0, capture: !0 }));
    }
    function pA(B) {
      B.key === "Control" && (Y = !1, I.domElement.getRootNode().removeEventListener("keyup", pA, { passive: !0, capture: !0 }));
    }
    function GA(B) {
    ...
    function s(B) {
      for (let N = 0; N < G.length; N++)
        if (G[N] == B.pointerId) return !0;
      return !1;
    }
    function a(B) {
      let N = J[B.pointerId];
      N === void 0 && (N = new j(), J[B.pointerId] = N), N.set(B.pageX, B.pageY);
    }
    function U(B) {
      const N = B.pointerId === G[0] ? G[1] : G[0];
      return J[N];
    }
    I.domElement.addEventListener("contextmenu", wA), I.domElement.addEventListener("pointerdown", uA), I.domElement.addEventListener("pointercancel", eA), I.domElement.addEventListener("wheel", xA, { passive: !1 }), I.domElement.getRootNode().addEventListener("keydown", OA, { passive: !0, capture: !0 }), this.update();
  }
}
class cQ extends rQ {
  constructor(A, g) {
...
var cA = Object.freeze({
  ...
  Linear: function(Q, A) {
    var g = Q.length - 1, I = g * A, C = Math.floor(I), E = gI.Utils.Linear;
  ...
  function() {
    function Q(A, g) {
      g === void 0 && (g = QI), this._object = A, this._group = g, this._isPaused = !1, this._pauseStart = 0, this._valuesStart = {}, this._valuesEnd = {}, this._valuesStartRepeat = {}, this._duration = 1e3, this._isDynamic = !1, this._initialRepeat = 0, this._repeat = 0, this._yoyo = !1, this._isPlaying = !1, this._reversed = !1, this._delayTime = 0, this._startTime = 0, this._easingFunction = cA.Linear.None, this._interpolationFunction = gI.Linear, this._chainedTweens = [], this._onStartCallbackFired = !1, this._onEveryStartCallbackFired = !1, this._id = jI.nextId(), this._isChainStopped = !1, this._propertiesAreSetUp = !1, this._goToEnd = !1;
    }
    return Q.prototype.getId = function() {
        ...
        if (!(R === "undefined" || R === "function")) {
          if (h) {
            ...
            for (var r = [D], F = 0, c = t.length; F < c; F += 1) {
              var e = this._handleRelativeValue(D, t[F]);
              if (isNaN(e)) {
      ...
      return A === void 0 && (A = QI), this._group = A, this;
      ...
      return A === void 0 && (A = gI.Linear), this._interpolationFunction = A, this;
...
class SQ extends qI {
  ...
  _createScene() {
    const A = new ag(), g = 14414079;
    return A.background = new jA(g), A.fog = new II(g, 0), A;
  }
  ...
  _createCamera() {
    const A = new Rg(70, 1, 0.1, 5e4);
    return A.position.set(0, 3e4, 0), A;
  }
  _createControls() {
    const E = new cQ(this.camera, this.container);
    return E.target.set(0, 0, -3e3), E.screenSpacePanning = !1, E.minDistance = 0.1, E.maxDistance = 3e4, E.maxPolarAngle = 1.2, E.enableDamping = !0, E.dampingFactor = 0.05, E.keyPanSpeed = 5, this.container.tabIndex = 0, E.listenToKeyEvents(this.container), E.addEventListener("change", () => {
      ...
      E.zoomSpeed = Math.max(Math.log(D), 0) + 0.5, this.camera.far = BI.clamp(D / i * 8, 100, 5e4), this.camera.near = this.camera.far / 1e3, this.camera.updateProjectionMatrix(), this.scene.fog instanceof II && (this.scene.fog.density = i / (D + 5) * this.fogFactor * 0.25);
      const o = D > 8e3;
  ...
  animate() {
    this.controls.update(), this.renderer.render(this.scene, this.camera), GQ(), this.dispatchEvent({ type: "update", delta: this._clock.getDelta() });
  }
  /**
   * Fly to a position
  ...
  flyTo(A, g, I = !0, C) {
    if (this.controls.target.copy(A), I) {
      ...
      new LI(E).to({ y: 1e4, z: 0 }, 500).chain(
        new LI(E).to(g, 2e3).easing(cA.Quintic.Out).onComplete((i) => C && C(i))
      ).start();
    } else
...
class vI extends CI {
  ...
  constructor(A, g = new jA(6724044)) {
    super(new XA(5, 5), new VI({ bkColor: A, airColor: g })), this.renderOrder = 999;
  }
}
function kQ(Q, A = 14414079, g = 6724044) {
  const I = new vI(new jA(A), new jA(g));
...
function qQ(Q) {
  ...
  return Q.rootTile.traverse((i) => {
    i.isTile && (A++, i.isLeaf && (C++, i.inFrustum && g++), I = Math.max(I, i.z), E = X.downloadThreads);
...
const pQ = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  createFrakEarth: kQ,
  getAttributions: dQ,
  getLocalFromMouse: JQ,
  getTileCount: qQ,
  limitCameraHeight: KQ
...
export {
  ...
  fQ as PromiseWorker,
  X as Tile,
  xQ as TileCanvasLoader,
  iI as TileGeometry,
  xI as TileGeometryLoader,
  uI as TileLoader,
  xg as TileLoadingManager,
  qA as TileMap,
  YI as TileMaterial,
  Wg as TileMaterialLoader,
  XI as TileSource,
  uQ as TileTextureLoader,
  JA as VectorFeatureTypes,
  lQ as VectorTileRender,
  HI as addSkirt,
  Zg as attachEvent,
  NI as author,
  PA as concatenateTypedArrays,
  OQ as createBillboards,
  DI as getBoundsCoord,
  Hg as getGeometryDataFromDem,
  lI as getGridIndices,
  WI as getLocalInfoFromRay,
  bg as getLocalInfoFromScreen,
  FI as getLocalInfoFromWorld,
  fI as getNormals,
  oI as getSafeTileUrlAndBounds,
  pQ as plugin,
  rg as version,
  WQ as waitFor
};
