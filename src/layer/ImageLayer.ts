/**
 * three-tile未使用layer概念，一些用户提出使用layer来对渲染效果分层设置，有这个想法，但three-tile的原则
 * 提供一个轻量级地图Mesh，并不想做一个GIS系统，另外改动对代码结构影响较大，暂未使用。
 *
 * 实现：
 ...
 *
 * 难点：
 * 修改layer渲染相关属性后，该layer关联的所有瓦片需要重新渲染，如何根据图层找到其包含的瓦片（几何体、材质、纹理）？
